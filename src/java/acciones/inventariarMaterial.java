 ...
 * @author eliu
 */
@WebServlet(name = "inventariarMaterial", urlPatterns = {"/inventariarMaterial"})
public class inventariarMaterial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Producto p1 = (Producto) p.obten(new Producto(id));
        Material m = new Material(p1,Integer.parseInt(cantidad));
        p.inventariar(m);
